 ...
 * within this plugin.
 */
class IPICOXRDPModule : public IHeadMountedDisplayModule
{
...
public:
	 ...
	 */
	static inline IPICOXRDPModule& Get()
	{
		return FModuleManager::LoadModuleChecked< IPICOXRDPModule >( "PICOXRPreview" );
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded( "PICOXRPreview" );
	}
