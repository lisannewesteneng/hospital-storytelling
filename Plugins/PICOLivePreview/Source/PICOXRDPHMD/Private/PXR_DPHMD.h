 ...
 */
class FPICOXRHMDDP : public FHeadMountedDisplayBase, public FXRRenderTargetManager, public TStereoLayerManager<FPICODPLayer>, public FSceneViewExtensionBase
{
public:
	/** Constructor */
...
private:
	...
	void TransferImage_RenderThread(FRHICommandListImmediate& RHICmdList, FRHITexture2D* SrcTexture, FIntRect SrcRect, FRHITexture2D* DstTexture, FIntRect DstRect, bool bLeft, bool bNoAlpha) const;
public:
...
private:
	...
	void OnFovStateChanged(const DeviceFovInfo& FovInfo);
